...
\cvitem{$\bullet$}{Languages: C, C++, C\#, Racket, and Java}
\cvitem{$\bullet$}{Software and Technologies: Visual Studio, Visual Studio Code, Unity, Unreal Engine, Game Maker Studio 2, Emacs, OpenGL}
...
\cvitem{$\bullet$}{Japanese language beginner able to read, write, and speak basic sentences.} 
% \cvitem{$\bullet$}{}
% \cvitem{$\bullet$}{}
% \vspace{10pt}
\definecolor{color1}{rgb}{0.22,0.45,0.70}
...
\section{Employment}
\colorlet{color1}{black}
\subsection{\textbf{Research Assistant Classroom Simulations (Sep23--Present)}}
...
\cvitem{$\bullet$}{Tutored roughly ten students a week on fundamental Computer Science concepts such as object oriented programming, data structures, and computer systems.}
...
\subsection{\textbf{United States Navy Aviation Electronics Technician (June15--June19)}}
...
\cvitem{$\bullet$}{Worked in a team of four developers to produce a plugin for a virtual world application that is used in several WWU research papers.}
\cvitem{$\bullet$}{Extensively utilized Git on Github to collaborate on the project, resolving many merges of at least four branches.}
...
\cvitem{$\bullet$}{Worked in a team of four Game Developers to create a 3D person action puzzle game spanning two levels using the Unity game engine.}
...
\cvitem{$\bullet$}{Wrote various shaders that can apply an image texture to an object and simulate dynamic lighting  in the OpenGl Shading Language, or GLSL.}
