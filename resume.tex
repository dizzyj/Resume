...
\cvitem{$\bullet$}{Languages: C, \textbf{C++}, \textbf{C\#}, Racket, and Java}
\cvitem{$\bullet$}{Software and Technologies: Visual Studio, Visual Studio Code, Unity, Unreal Engine, Game Maker Studio 2, Emacs, \textbf{OpenGL}}
\cvitem{$\bullet$}{Experienced in developing in both Windows and Linux envirionments}
...
\cvitem{$\bullet$}{Western Washington University | \textbf{ABET Accredited} |  (Expected Spring 2024)}
...
\cvitem{$\bullet$}{Worked in a team of four developers to produce a plugin using \textbf{C\#} for a virtual world application that is used in several WWU research papers.}
\cvitem{$\bullet$}{Extensively utilized Git on Github to collaborate on the project.}
