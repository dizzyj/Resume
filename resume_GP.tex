...
\cvitem{$\bullet$}{Languages: C, C++, C\#, JavaScript, Ruby, SQL, XAML, HTML, CSS, XML, Python, Bash, and Java}
\cvitem{$\bullet$}{Software and Technologies: Visual Studio, Visual Studio Code, Unity, Unreal Engine, Game Maker Studio 2, OpenGL, .Net MAUI,\hspace{10mm} React, React-Native, NodeJS, Microsoft Word, Microsoft Excel}
...
\cvitem{$\bullet$}{Western Washington University Graduated June 2024}
\subsection{Relevant Coursework:} 
\begin{multicols}{3}
\cvitem{$\bullet$}{Algorithms}
\cvitem{$\bullet$}{Operating Systems}
\cvitem{$\bullet$}{Networking- HTTP/S, TCP/IP, DNS, DHCP, NTP, SMTP}
\columnbreak
...
\subsection{Research Assistant Classroom Simulations (Sep23--Jun24)}
...
% \subsection{Portfolio and Blog Web Application (.Net)}
% \cvitem{$\bullet$}{Programmed front and back end allowing the user to display their previous projects as well as communicate via blog posts}
...
\cvitem{$\bullet$}{A personal project to learn graphics programming. Consists of a scene that a can be navigated around using the keyboard.}
...
\cvitem{$\bullet$}{3D action adventure game where I designed, and programmed, levels, enemies behaviors, and core game mechanics alongside a team of 3 other developers}
